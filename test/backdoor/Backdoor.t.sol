...
import {HackWalletRegistry} from "../../src/backdoor/HackWalletRegistry.sol";
...
contract BackdoorChallenge is Test {
    ...
    function test_backdoor() public checkSolvedByPlayer {
        ...
        HackWalletRegistry hackRegistry = new HackWalletRegistry();
        hackRegistry.attack(walletFactory, address(singletonCopy), users, walletRegistry, address(token), address(recovery));
